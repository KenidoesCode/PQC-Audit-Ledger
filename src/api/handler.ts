 ...
 *
 * A cryptographic failure returns its reason. Section 134 is explicit that
 * hiding why verification failed is worse than useless: it teaches operators
 * that verification errors are noise.
 */
